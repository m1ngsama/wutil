...
export default function Navbar() {
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-edge bg-canvas/90 backdrop-blur-md">
        ...
        <div className="flex h-14 items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              className="h-8 w-8 flex items-center justify-center rounded-md text-ink-3 hover:text-ink hover:bg-muted transition-colors"
              aria-label="GitHub"
            >
